...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('api-admin.index')}}">
            ...
            <div class="sidebar-brand-text mx-3">Reviewfood</div>
        </a>
        <!-- Divider -->
...
{{--                    <h6 class="collapse-header">Custom Components:</h6>--}}
        ...
        <hr class="sidebar-divider">
        <li class="nav-item {{\Request::route()->getName() == 'admin.index.rating' ? 'active' : ''}}">
            <a class="nav-link" href="{{route('admin.index.rating')}}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Your Website 2021 By Thanh Tùng</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
