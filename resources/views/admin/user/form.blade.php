<form action="" method="POST">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-8">
            ...
            <div class="form-group">
                <label for="inputName" class="col-form-label" >Phone thành viên</label>
                <input type="text" class="form-control" id="inputName" placeholder="Phone thành viên..." value="{{old('phone',isset($user->phone) ? $user->phone : '')}}" name="phone">
                @if($errors->has('phone'))
                    <div class="error-txt">{{ $errors->first('phone') }}</div>
                @endif
            </div>
            <div class="form-group ">
